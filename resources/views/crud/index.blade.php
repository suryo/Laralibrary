                ...
                <table class="table align-middle table-striped table-bordered table-row-dashed">
                  <thead>
                    <tr>
                        ...
                        <th rowspan="2" style="vertical-align: middle; text-align: center;">OPT</th>
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <select class="form-select form-select-solid" id="opt" name="{{$field->Field.'_opt'}}"  data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" onchange="opti(this.value, '{{ $field->Field }}')">
                            <option value="none">none</option>
                            <option value="join">Join Table</option>
                          </select>


                          <div class="border rounded-bottom border-dark-subtle" style="display: none" id="{{$field->Field.'_table_reference'}}">
                          <label for="" class="fw-bold" style="padding: .775rem 3rem .775rem 1rem;">Table Reference</label>
                          <select class="form-select form-select-solid w-100" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" name="{{$field->Field.'_table_reference'}}" onchange="findfield(this.value,'{{ $field->Field }}')">>
                          ...
                          <label for="" class="fw-bold" style="padding: .775rem 3rem .775rem 1rem;">Operator Logic</label>
                          <select class="form-select form-select-solid w-100" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" name="{{$field->Field.'_opt_logic'}}" >
                            <option value="" selected>Not Selected</option> 
                            <option value="="> Equal</option>  
                            <option value="">Not equal</option>
                          </select>

                          <label for="" class="fw-bold" style="padding: .775rem 3rem .775rem 1rem;">Field Key</label>
                          <select id="{{$field->Field.'_field_reference'}}" class="form-select form-select-solid w-100" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" name="{{$field->Field.'_field_reference'}}" >
                            <option value="" selected>Not Selected</option>    
                          </select>

                          <label for="" class="fw-bold" style="padding: .775rem 3rem .775rem 1rem;">Field Show</label>
                          <select id="{{$field->Field.'_field_show'}}" class="form-select form-select-solid w-100" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" name="{{$field->Field.'_field_show'}}" >
                            <option value="" selected>Not Selected</option>    
                          </select>
                          </div>
                          ...
                          <script>
                            function opti(selector, field){
                              console.log(field+'_table_reference')
                              if(selector=="join"){
                                document.getElementById(field+'_table_reference').style.display = "block";
                              } else{
                                document.getElementById(field+'_table_reference').style.display = "none";
                              }
                            }
